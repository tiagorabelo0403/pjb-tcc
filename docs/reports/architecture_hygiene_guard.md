...
- Arquivos Java: **8052**
- Raízes de pacote: **26**
- Classes acima de 1000 linhas: **20**
...
- `model.repository` -> 151 arquivos

## Maiores hotspots de classe

- `pjb-api\src\main\java\com\tcc\pjb\backend\service\competencia\MapaCompetenciaDinamicoEngine.java` -> 1196 linhas (service_or_engine)
...
- `pjb-api\src\main\java\com\tcc\pjb\backend\service\advogado\LaianePeticaoInicialDraftService.java` -> 1129 linhas (service_or_engine)
