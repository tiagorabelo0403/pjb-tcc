...
class FederalismoRedistribuicaoServiceTest {
    ...
    private static Jurisdicao jurisdicao(Long id,
        ...
        Tribunal tribunal = new Tribunal(sigla, nome, TipoJustica.ESTADUAL, GrauJurisdicao.PRIMEIRO_GRAU, uf);
        jurisdicao.setComarcaEntidade(new Comarca(comarca, uf, "2304400", null, tribunal));
