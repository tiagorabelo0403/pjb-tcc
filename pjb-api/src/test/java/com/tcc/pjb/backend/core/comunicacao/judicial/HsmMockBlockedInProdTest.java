...
class HsmMockBlockedInProdTest {
    ...
    @Test
    void hsmMockEnabledEmProd_bloqueiaStartup() {
    ...
    @Test
    void hsmMockDisabledEmProd_permiteStartup() {
        MockEnvironment env = new MockEnvironment();
        env.setActiveProfiles("prod");
    ...
    @Test
    void hsmMockEnabledEmTest_permiteStartup() {
        MockEnvironment env = new MockEnvironment();
