...
create index idx_julg_cov_proc_created on tb_julgamento_coverage_audit (processo_id, created_at);
create index idx_julg_cov_user_created on tb_julgamento_coverage_audit (usuario_id, created_at);
create index idx_julg_cov_status_act on tb_julgamento_coverage_audit (overall_status, act_type);
