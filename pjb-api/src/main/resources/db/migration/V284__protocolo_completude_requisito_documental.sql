...
-- COMUM_ORDINARIO: declaração de hipossuficiência — apenas se PEDE_JUSTICA_GRATUITA
...
-- TRABALHISTA_ORDINARIO: CTPS — vínculo empregatício (CLT art. 41 + TST IN 39/2016)
...
-- ESPECIAL_HABEAS_CORPUS: qualificação do paciente (CPP art. 654 §1º)
...
-- ESPECIAL_HABEAS_CORPUS: BO como advertência (quando disponível)
