...
public record ExecutionClosureGovernanceProfile(
        String closureMode,
        String closureConsistencyStatus,
        String archiveReadiness,
        String residualDispositionMode,
        String preferenceClosureMode,
        String subrogationClosureMode,
        String settlementClosureMode,
        String closureDesk,
        String queueCode,
        String inboxKey,
    ...
    public ExecutionClosureGovernanceProfile {
    ...
    public String descriptor() {
        return String.join(":",
                ...
                firstNonBlank(closureConsistencyStatus, "CONSISTENCIA"),
                firstNonBlank(archiveReadiness, "ARQUIVO"),
    ...
    public Map<String, Object> toMap() {
        ...
        out.put("closureConsistencyStatus", closureConsistencyStatus);
        out.put("archiveReadiness", archiveReadiness);
        out.put("residualDispositionMode", residualDispositionMode);
        out.put("preferenceClosureMode", preferenceClosureMode);
        out.put("subrogationClosureMode", subrogationClosureMode);
        out.put("settlementClosureMode", settlementClosureMode);
        out.put("closureDesk", closureDesk);
