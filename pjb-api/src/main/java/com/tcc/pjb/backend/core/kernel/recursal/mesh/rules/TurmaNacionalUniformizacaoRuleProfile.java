...
public final class TurmaNacionalUniformizacaoRuleProfile extends AbstractRecursalRuleProfile {

    public TurmaNacionalUniformizacaoRuleProfile() {
        super(RecursalTribunal.TNU);
    }

    @Override
    public String name() {
        return "TNU_RULE_PROFILE";
    }
    ...
    public RecursalRoutePlan route(RecursalCaseContext context, RecursalSpecies species) {
        ...
        return switch (species) {
            ...
            case AgravoRecursoExtraordinario ignored -> externalPlan(
                    ...
                    new PreventionDisposition(true, false, true, true));
            case ApelacaoCivel ignored -> throw new IllegalArgumentException("A TNU não recebe apelação cível nesta malha");
            case ApelacaoPenal ignored -> throw new IllegalArgumentException("A TNU não recebe apelação penal nesta malha");
            case RecursoEspecial ignored -> throw new IllegalArgumentException("A TNU não processa recurso especial nesta malha");
            case AgravoRecursoEspecial ignored -> throw new IllegalArgumentException("A TNU não processa agravo em recurso especial nesta malha");
            case EmbargosDivergencia ignored -> throw new IllegalArgumentException("Embargos de divergência não são cabíveis na TNU nesta malha");
