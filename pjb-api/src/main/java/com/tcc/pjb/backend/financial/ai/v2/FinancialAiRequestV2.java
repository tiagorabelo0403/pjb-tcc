package com.tcc.pjb.backend.financial.ai.v2;
...
@JsonDeserialize(builder = FinancialAiRequestV2.Builder.class)
@JsonIgnoreProperties(ignoreUnknown = true)
public final class FinancialAiRequestV2 implements Serializable {
    ...
    private FinancialAiRequestV2(Builder b) {
    ...
    public static final class Builder {
        ...
        public FinancialAiRequestV2 build() {
            return new FinancialAiRequestV2(this);
        }
    }
}
