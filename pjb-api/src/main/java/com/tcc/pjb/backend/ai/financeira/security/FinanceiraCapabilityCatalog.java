...
@Component
@RefreshScope
public class FinanceiraCapabilityCatalog implements CapabilityCatalog {
    ...
    public FinanceiraCapabilityCatalog(FinanceiraCapabilityCatalogProperties props) {
    ...
    private static Set<String> canonicalSet(List<String> input) {
        ...
        HashSet<String> out = new HashSet<>(Math.max(16, input.size() * 2));
        for (String v : input) {
