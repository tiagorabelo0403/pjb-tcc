...
@JsonDeserialize(builder = LegalSkillRequestV2.Builder.class)
@JsonIgnoreProperties(ignoreUnknown = true)
public final class LegalSkillRequestV2 implements Serializable, LegalSkillRequestContract {
    ...
    private LegalSkillRequestV2(Builder b) {
        ...
        this.contractVersion = b.contractVersion != null ? b.contractVersion : "v2";
    ...
    public static final class Builder {
        ...
        public LegalSkillRequestV2 build() {
            return new LegalSkillRequestV2(this);
        }
    }
}
