...
public record PostJudgmentOperationalProfile(
    ...
    public PostJudgmentOperationalProfile {
    ...
    public Instant dueAtFrom(Instant base) {
        ...
        return anchor.plus(dueAmount, dueUnit);
    }

    public String descriptor() {
        return String.join(":",
                firstNonBlank(operationMode, "OPERACAO"),
                firstNonBlank(executionTrack, archiveTrack, "TRILHA"),
                firstNonBlank(reviewDesk, "MESA"),
    ...
    public Map<String, Object> toMap() {
        ...
        out.put("resJudicataScope", resJudicataScope);
        out.put("executionTrack", executionTrack);
        out.put("archiveTrack", archiveTrack);
