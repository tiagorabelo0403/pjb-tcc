package com.tcc.pjb.backend.financial.ai.v1;
...
@JsonDeserialize(builder = FinancialAiRequestV1.Builder.class)
@JsonIgnoreProperties(ignoreUnknown = true)
public final class FinancialAiRequestV1 implements Serializable {
    ...
    private FinancialAiRequestV1(Builder b) {
    ...
    public static final class Builder {
        ...
        public FinancialAiRequestV1 build() {
            return new FinancialAiRequestV1(this);
        }
    }
}
