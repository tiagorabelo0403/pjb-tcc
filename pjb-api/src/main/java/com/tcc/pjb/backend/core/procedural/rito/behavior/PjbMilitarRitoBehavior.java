...
public record PjbMilitarRitoBehavior(RitoProcessual rito) implements PjbRitoBehavior {

    @Override public String prazoPolicy() { return "PRAZO_MILITAR"; }
    @Override public String movementPolicy() { return "MILITAR_COMPLETO"; }
    ...
    public List<String> defaultVisibleActions() {
        return List.of("VISUALIZAR_CAPA", "JUNTAR_DOCUMENTO", "CONSULTAR_PRAZOS", "ATOS_MILITARES", "CONSELHO_DE_JUSTICA_MILITAR", "IPM_REGISTRO");
    }
    ...
    public List<String> defaultValidations() {
        return List.of("VALIDAR_HIERARQUIA_MILITAR", "VALIDAR_COMPETENCIA_JUSTICA_MILITAR");
    }
    ...
    public List<String> firstMovements(int urgencyScore) {
        ...
        movements.add("VERIFICAR_COMPETENCIA_JUSTICA_MILITAR");
        movements.add("VERIFICAR_HIERARQUIA_E_SUBORDINACAO_MILITAR");
