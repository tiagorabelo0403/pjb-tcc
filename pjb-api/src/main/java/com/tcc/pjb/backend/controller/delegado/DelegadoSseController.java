...
@RestController
@RequestMapping("/api/v1/delegado/live")
public class DelegadoSseController {

    private final UiHistoryLiveHub hub;
    private final CurrentUserService currentUserService;
    private final PerfilRealtimeTopicService topicService;

    public DelegadoSseController(UiHistoryLiveHub hub, CurrentUserService currentUserService, PerfilRealtimeTopicService topicService) {
        this.hub = hub;
    ...
    public SseEmitter stream(@RequestHeader(name = "Last-Event-ID", required = false) String lastEventId) {
        ...
        String topic = topicService.territoryTopic(usuario, "DELEGADO");
