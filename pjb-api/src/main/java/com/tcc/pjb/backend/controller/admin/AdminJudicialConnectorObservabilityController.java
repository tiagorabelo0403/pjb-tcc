...
@RestController
@RequestMapping("/api/admin/judicial/observability")
public class AdminJudicialConnectorObservabilityController {

    private final AdminJudicialConnectorRuntimeSurfaceFacadeService facadeService;

    public AdminJudicialConnectorObservabilityController(AdminJudicialConnectorRuntimeSurfaceFacadeService facadeService) {
    ...
    public ResponseEntity<SurfaceSnapshotResponse> national(@RequestParam(defaultValue = "24") long hours) {
        return ResponseEntity.ok(facadeService.observabilityNational(hours));
    }
    ...
    public ResponseEntity<SurfaceSnapshotResponse> tribunal(@PathVariable String tribunalCodigo,
        ...
        return ResponseEntity.ok(facadeService.observabilityTribunal(tribunalCodigo, hours));
    }
}
