...
public interface PjbAuthorizationTrailReadModelRepository extends JpaRepository<PjbAuthorizationTrailReadModelEntry, AuthzTrailId> {
    ...
    @Query("""
           ...
           where e.occurredAt >= :occurredAfter
             and e.occurredAt < :occurredBefore
             and e.occurredMonth between :startMonth and :endMonth
           order by e.occurredAt asc, e.id asc
           """)
    List<PjbAuthorizationTrailReadModelEntry> findByOccurredAtWindowWithMonthRange(
    ...
    @Query("""
           ...
           order by e.occurredAt desc, e.id desc
           """)
    Page<PjbAuthorizationTrailReadModelEntry> searchForensics(@Param("actionPrefix") String actionPrefix,
                                                              @Param("resourceType") String resourceType,
                                                              @Param("resourceId") String resourceId,
                                                              @Param("actorId") Long actorId,
                                                              @Param("actorType") String actorType,
