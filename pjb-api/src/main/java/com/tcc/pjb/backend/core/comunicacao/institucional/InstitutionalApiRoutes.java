...
public final class InstitutionalApiRoutes {
    ...
    public static final String PATH_REPRESENTANTE_VERIFICACAO = "/representantes/verificacao/{requestId}";
    public static final String PATH_VINCULOS_APROVACAO = "/vinculos/aprovacao";
    public static final String PATH_IDENTIDADE_GUARDA = "/identidade/guarda";
    public static final String PATH_POLITICA_STEP_UP = "/politica-step-up";
    public static final String PATH_CONTEXTOS_ATIVACAO = "/contextos/ativacao";
    public static final String PATH_FECHAMENTO_TEXTO = "/fechamento-texto";
    public static final String PATH_CATALOGO_CANONICO = "/catalogo-canonico";
    public static final String PATH_RECEBER_LOTE = "/receber-lote";
    public static final String PATH_CERTIFICAR_CIENCIA_LOTE = "/certificar-ciencia-lote";
    public static final String PATH_TRIAGEM_SUGERIDA = "/triagem-sugerida";
    public static final String PATH_CONTRATO_INTEGRACAO = "/contrato-integracao";
    public static final String PATH_COBERTURAS_OPERACIONAIS = "/coberturas-operacionais";
    public static final String PATH_COBERTURAS_OPERACIONAIS_APLICAR = PATH_COBERTURAS_OPERACIONAIS + "/aplicar";
    public static final String PATH_COERENCIA_PROCESSUAL_DIAGNOSTICO = "/coerencia-processual/diagnostico";
    public static final String PATH_COERENCIA_PROCESSUAL_PROFILE = "/coerencia-processual/{profileCode}";
    public static final String PATH_COERENCIA_PROCESSUAL_ATO = PATH_COERENCIA_PROCESSUAL_PROFILE + "/atos/{actionCode}";
    public static final String PATH_TOPOLOGIA_DESTINATARIOS = "/topologia-destinatarios";
    public static final String PATH_PAPEIS_PROCESSUAIS = "/papeis-processuais";
    public static final String PATH_PAPEIS_PROCESSUAIS_PROFILE = PATH_PAPEIS_PROCESSUAIS + "/{profileCode}";
    public static final String PATH_PAPEIS_PROCESSUAIS_DIAGNOSTICO = PATH_PAPEIS_PROCESSUAIS + "/diagnostico";
