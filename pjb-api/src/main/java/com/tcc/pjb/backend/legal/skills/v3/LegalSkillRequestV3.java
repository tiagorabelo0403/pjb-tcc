...
@JsonDeserialize(builder = LegalSkillRequestV3.Builder.class)
@JsonIgnoreProperties(ignoreUnknown = true)
public final class LegalSkillRequestV3 implements Serializable, LegalSkillRequestContract {
    ...
    private LegalSkillRequestV3(Builder b) {
    ...
    public static final class Builder {
        ...
        public LegalSkillRequestV3 build() {
            return new LegalSkillRequestV3(this);
        }
    }
}
