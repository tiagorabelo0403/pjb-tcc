...
public final class SuperiorTribunalMilitarRuleProfile extends AbstractRecursalRuleProfile {

    public SuperiorTribunalMilitarRuleProfile() {
        super(RecursalTribunal.STM);
    }

    @Override
    public String name() {
        return "STM_RULE_PROFILE";
    }
    ...
    public RecursalRoutePlan route(RecursalCaseContext context, RecursalSpecies species) {
        ...
        return switch (species) {
            ...
            case AgravoRecursoExtraordinario ignored -> externalPlan(
                    ...
                    new PreventionDisposition(true, false, true, true));
            case ApelacaoCivel ignored -> throw new IllegalArgumentException("Espécie incompatível com STM como origem nesta malha");
            case ApelacaoPenal ignored -> throw new IllegalArgumentException("Espécie incompatível com STM como origem nesta malha");
            case RecursoEspecial ignored -> throw new IllegalArgumentException("Espécie incompatível com STM como origem nesta malha");
            case AgravoRecursoEspecial ignored -> throw new IllegalArgumentException("Espécie incompatível com STM como origem nesta malha");
            case EmbargosDivergencia ignored -> throw new IllegalArgumentException("Embargos de divergência não são cabíveis no STM nesta malha");
