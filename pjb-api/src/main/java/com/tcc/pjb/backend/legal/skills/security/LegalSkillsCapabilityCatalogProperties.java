...
@ConfigurationProperties(prefix = "pjb.security.legal.skills.capability-catalog")
public class LegalSkillsCapabilityCatalogProperties {
    ...
    public void setAllowContainsAny(List<String> allowContainsAny) {
        this.allowContainsAny = allowContainsAny;
    }
}
